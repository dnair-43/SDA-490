  ...
  tags$head(
    ...
    tags$style(HTML("
      ...
      * { box-sizing: border-box; }
      ...
      .page-footer-left { font-size: 0.6rem; color: #9ca3af; letter-spacing: 0.06em; line-height: 1.7; }
      .page-footer-right { font-size: 0.6rem; color: #9ca3af; letter-spacing: 0.06em; }
      ...
      .votes-leg-item {
        ...
        font-size: 0.64rem; color: #6b7280; padding: 2px 0;
      }
      .votes-leg-swatch {
      ...
      .reg-ctrl-label {
        ...
        color: #9ca3af; margin-bottom: 8px; font-family: 'DM Mono', monospace;
      }
      .reg-section-title {
      ...
      .eq-main  { color: #0f172a; font-size: 0.85rem; font-weight: 500; }
      ...
      .reg-hint {
        font-size: 0.62rem; color: #9ca3af; line-height: 1.65; padding: 10px 12px;
        background: #eef2fa; border-left: 2px solid #3b82f644;
