...
wvs_y_choices <- c(
  ...
  "Resource Dependency (% GDP)"   = "resource_rents"
)
...
if (exists("vdem") && is.data.frame(vdem)) {
  scatter_vdem <- vdem %>%
    ...
    rename(
      ...
      resource_rents = any_of("e_total_resources_income_pc")
    )
} else {
...
# Merge V-Dem predictors + auth_index + Gini
scatter_full <- scatter_vdem %>%
  ...
  mutate(logged_wealth = NA_real_)   # country-level GNI not assembled here
...
ui <- navbarPage(
  title = div(
    ...
    "DEMOCRACY ", tags$span("INDEX", style = "color:#a8d8b9;"), " MAP"
  ),
  id = "nav",
  selected = "Overview",
  collapsible = TRUE,
  ...
  tags$head(
    ...
    tags$style(HTML("
      ...
      * { box-sizing: border-box; }
      ...
      .term-chip strong { color: #a8d8b9; font-weight: 400; }
      ...
      .irs--shiny .irs-bar { background: #a8d8b9; border-color: #a8d8b9; }
      .irs--shiny .irs-handle { border-color: #a8d8b9; background: #a8d8b9; }
      .irs--shiny .irs-from, .irs--shiny .irs-to,
      .irs--shiny .irs-single { background: #a8d8b9; color: #0e0e14; font-family: 'DM Mono'; }
      ...
      .rank-table td:last-child { text-align:right; color:#a8d8b9; }
      ...
      .btn-gold:hover { background: #c5e8d4; }
      .btn-dark {
        background: #2a2d3a;
        border: none;
        color: #e8e6df;
      ...
      .wvs-index-note {
        ...
        padding: 10px 12px;
        background: #1a1828;
        border-left: 2px solid #a8d8b944;
        border-radius: 0 6px 6px 0;
        font-family: 'DM Mono', monospace;
      }
      /* Override slider colours for WVS tab to match overview green */
      .wvs-sidebar .irs--shiny .irs-bar { background: #a8d8b9 !important; border-color: #a8d8b9 !important; }
      .wvs-sidebar .irs--shiny .irs-handle { background: #a8d8b9 !important; border-color: #a8d8b9 !important; }
      .wvs-sidebar .irs--shiny .irs-from,
      .wvs-sidebar .irs--shiny .irs-to,
      .wvs-sidebar .irs--shiny .irs-single { background: #a8d8b9 !important; color: #0e0e14 !important; }
      ...
      .wvs-sidebar .selectize-input .item {
        background: #e8f7f0 !important; border: 1px solid #a8d8b9 !important;
      ...
      .wvs-sidebar .selectize-input .item.active {
        background: #a8d8b9 !important; color: #0e0e14 !important;
      }
      ...
      .ctm-toggle-btn.active-auth {
        background: #1a4a2e; color: #a8d8b9; border-color: #2ecc71;
      }
      ...
      .eq-active { color: #a8d8b9; font-weight: 700; }
      ...
      .reg-stat-card .val {
        ...
        color: #a8d8b9; display: block; line-height: 1;
      }
      .reg-stat-card .lbl {
      ...
      .reg-hint {
        ...
        background: #1a1828; border-left: 2px solid #a8d8b944;
  ...
  tabPanel("Overview",
           div(class = "overview-page",
               ...
               div(class = "hero",
                   ...
                   div(class = "hero-lead",
                       "Which institutional-level and individual-level factors predict a rise in
           authoritarianism in the government? And what is the likelihood of a rise
           of authoritarianism in the Canadian government? We focused on this topic
           as we are all interested in understanding political conflicts and
           ...
           and is negatively affecting everyone."
                   ...
                   # Timeline chart
                   tags$div(
                     style = "margin: 24px 0 20px; background:#1a1828; border:1px solid #252235; border-radius:10px; padding:20px;",
                     tags$img(
                       src   = "Timeline.png",
                       alt   = "Electoral Democracy Index Timeline 1980–2025",
                       style = "width:100%; max-width:900px; display:block; border-radius:6px;",
                       onerror = "this.style.display='none'; document.getElementById('timeline-missing').style.display='block';"
                     ),
                     tags$div(
                       id    = "timeline-missing",
                       style = "display:none; padding:18px; color:#7a7090; font-size:0.78rem; text-align:center; border:1px dashed #2a2840; border-radius:6px;",
                       "⚠ Timeline.png not found — place it in the app's www/ folder."
                     ),
                     tags$p(
                       style = "font-size:0.72rem; color:#7a7090; line-height:1.75; margin-top:14px;",
                       ...
                       tags$b(style="color:#f1c40f;","2013"),
               ...
               div(class = "info-grid",
                   ...
                   div(class = "info-card",
                       ...
                       div(class = "info-card-body",
                           tags$p(tags$b(style="color:#a8d8b9;","Primary Research Question:"),
                                  " Which institutional-level and individual-level factors predict a rise in authoritarianism in the government?"),
                           tags$p(tags$b(style="color:#a8d8b9;","Secondary Research Question:"),
                   ...
                   div(class = "info-card",
                       ...
                       div(class = "info-card-title",
                           HTML("authoritarian <span style='color:#7a7090;font-size:0.85rem;font-weight:400;'>(adj.)</span>")
                       ),
                       div(class = "info-card-body",
                           ...
                           tags$p(style="font-size:0.68rem;color:#5a5470;",
                                  "Source: ",
                   ...
                   div(class = "info-card",
                       ...
                       div(class = "info-card-body",
                           tags$p(tags$b(style="color:#a8d8b9;","Authoritarian Values Index:"),
                           ...
                           tags$p(tags$b(style="color:#a8d8b9;","Authoritarian Government Index:"),
                                  " Uses V-Dem scores to measure countries on a scale of 0–1
                                  (0 = autocracy, 1 = the most liberal democracy)."),
                           tags$p(tags$b(style="color:#a8d8b9;","Canadian Authoritarian Values Index:"),
                   ...
                   div(class = "info-card",
                       ...
                       div(class = "info-card-body",
                           tags$p(tags$b(style="color:#a8d8b9;","V-Dem (Varieties of Democracy):"),
                                  " Provides hundreds of indicators on \"liberal\" vs. \"authoritarian\" practices
                                  (e.g., media censorship, judicial independence)."),
                           tags$p(tags$b(style="color:#a8d8b9;","World Values Survey (WVS):"),
                           ...
                           tags$p(tags$b(style="color:#a8d8b9;","CTM Data:"),
  ...
  tabPanel("Interactive Map",
           div(class = "map-page-wrap",
               ...
               div(class = "side-panel",
                   ...
                   div(
                     style = "background:#1a1828; border:1px solid #252235; border-radius:8px; padding:12px 14px; font-size:0.68rem; color:#7a7090; line-height:1.7;",
           ...
           div(class = "wvs-wrap",
               ...
               div(class = "wvs-sidebar",
                   ...
                   div(class = "wvs-index-note",
                       ...
                       tags$b("Resource Dependency"), " (% GDP, World Bank), ",
               ...
               div(class = "reg-sidebar",
                   ...
                   div(
                     ...
                     background:#1a1828; border:1px solid #252235; border-radius:6px; padding:8px 10px;",
                       tags$b(style="color:#a8d8b9;", "v2x_polyarchy"),
                       " — V-Dem Electoral Democracy Index (0–1 scale). All variables are standardized (scaled)
            so coefficients represent standard-deviation effects."
                     )
                   ),
                   ...
                   div(
                     ...
                     div(class = "reg-hint",
                         tags$b(style="color:#a8d8b9;","Social Polarization"), " — V-Dem v2cacamps. Measure of how divided society is into different camps.", tags$br(), tags$br(),
                         tags$b(style="color:#a8d8b9;","Digital Freedom"), " — V-Dem v2mecenefm. Freedom of expression and information online (higher = freer).", tags$br(), tags$br(),
                         tags$b(style="color:#a8d8b9;","Party Strength"), " — V-Dem v2xps_party. Institutionalization of political parties.", tags$br(), tags$br(),
                         tags$b(style="color:#a8d8b9;","Resource Dependency"), " — World Bank resource rents as % of GDP (\"resource curse\").", tags$br(), tags$br(),
                         tags$b(style="color:#a8d8b9;","Logged Wealth"), " — ln(GNI per capita). Logged because wealth has diminishing returns.", tags$br(), tags$br(),
                         tags$b(style="color:#a8d8b9;","Inequality"), " — SWIID gini_disp. Disposable-income Gini coefficient.", tags$br(), tags$br(),
                         tags$b(style="color:#a8d8b9;","Auth Values"), " — WVS authoritarian values index (0–1; higher = more authoritarian)."
                     )
                   ),
                   ...
                   div(class = "reg-hint",
                       tags$b(style="color:#5a8a70;","Global cross-national model. "),
                       "Unit of analysis: country × WVS wave.",
                       tags$br(), tags$br(),
                       "Data sources: V-Dem v16 · World Bank WDI · SWIID v9.91 · World Values Survey.",
                       tags$br(), tags$br(),
                       "All predictors are standardized — coefficients are directly comparable."
                   )
               ...
               div(class = "reg-main",
                   ...
                   div(class = "reg-section-title", "Model: Predictors of Polyarchy (Electoral Democracy)"),
                   div(
                     style = "background:#1a1828; border:1px solid #252235; border-radius:8px; padding:12px 14px;
                              font-size:0.72rem; color:#9a94aa; line-height:1.7; font-family:'DM Mono',monospace; margin-bottom:8px;",
                     HTML("scale(Polyarchy) ≈ <span style='color:#a8d8b9;'>Digital Freedom (+)</span> + 
                          <span style='color:#a8d8b9;'>Party Strength (+)</span> + 
                          <span style='color:#a8d8b9;'>Wealth (+)</span> + 
                          <span style='color:#a8d8b9;'>Inequality (+)</span> + 
                          <span style='color:#a8d8b9;'>Polarization (+)</span> − 
                          <span style='color:#e06c75;'>Resource Dependency (−)</span> + 
                          <span style='color:#a8d8b9;'>Auth Values (+)</span>"),
                     tags$br(),
                     tags$span(style="font-size:0.62rem; color:#5a5470;",
                               "Global cross-national model (V-Dem · WB · SWIID · WVS). All variables standardized (scaled).")
                   ),
                   ...
                   # Top 10 countries experiencing democratic backsliding
                   div(class="reg-section-title", style="margin-top:16px;",
                       "Top 10 Countries Experiencing the Most Severe Democratic Backsliding Since 1980"),
                   div(
                     style = "background:#1a1828; border:1px solid #252235; border-radius:10px; padding:16px; text-align:center;",
                     tags$img(
                       src   = "top10countriesecperiencingdemobacksliding.png",
                       style = "width:100%; max-width:900px; border-radius:6px; display:inline-block;"
                     ),
                     tags$p(
                       style = "font-size:0.68rem; color:#5a5470; margin-top:10px;",
                       "Countries ranked by the largest decline in V-Dem Electoral Democracy Index (v2x_polyarchy) from 1980 to 2025."
                     )
                   )
  ...
  tabPanel("Conclusion",
           div(
             style = "min-height: calc(100vh - 56px); background: #0e0e14; overflow-y: auto;",
             
             # ── Hero band ─────────────────────────────────────────────────
             div(
               style = "background: linear-gradient(160deg, #0e0e14 0%, #15102a 50%, #0e1a14 100%);
                        padding: 60px 10% 48px; border-bottom: 1px solid #1e1c2a; position: relative;",
               div(style = "font-size:0.6rem; letter-spacing:0.22em; text-transform:uppercase;
                            color:#a8d8b9; margin-bottom:16px;", "Summary of Findings"),
               div(
                 style = "font-family:'Syne',sans-serif; font-weight:800;
                          font-size:clamp(1.8rem,4vw,3rem); line-height:1.08;
                          letter-spacing:-0.03em; color:#f0ece0; max-width:760px; margin-bottom:0;",
                 "Conclusions"
               )
             ),
             ...
             div(
               style = "display:grid; grid-template-columns: repeat(auto-fit,minmax(320px,1fr));
                        gap:1px; background:#1e1c2a;",
               
               # ── Findings ──────────────────────────────────────────────
               div(
                 style = "background:#0e0e14; padding:44px 40px;",
                 div(style = "font-size:0.58rem; letter-spacing:0.2em; text-transform:uppercase;
                              color:#a8d8b9; margin-bottom:14px;", "Key Findings"),
                 div(
                   style = "font-family:'Syne',sans-serif; font-weight:700; font-size:1.1rem;
                            color:#f0ece0; margin-bottom:18px; line-height:1.3;",
                   "Institutional-Level Factors Drive Authoritarianism"
                 ),
                 tags$p(
                   style = "font-size:0.78rem; line-height:1.85; color:#7a7090; margin-bottom:12px;",
                 ...
                 tags$p(
                   style = "font-size:0.78rem; line-height:1.85; color:#7a7090; margin-bottom:0;",
               ...
               div(
                 ...
                 div(
                   style = "font-family:'Syne',sans-serif; font-weight:700; font-size:1.1rem;
                            color:#f0ece0; margin-bottom:20px; line-height:1.3;",
                   ...
                   div(
                     ...
                     div(
                       style = "font-family:'Syne',sans-serif; font-weight:700; font-size:0.88rem;
                                color:#f0ece0; line-height:1.4;",
                       "Authoritarianism is Multidimensional"
                     )
                   ),
                   tags$p(
                     style = "font-size:0.75rem; line-height:1.8; color:#7a7090; padding-left:16px;",
             ...
             div(
               ...
               div(
                 style = "font-size:0.6rem; color:#3a3450; letter-spacing:0.06em; line-height:1.7;",
               ...
               div(style = "font-size:0.6rem; color:#3a3450; letter-spacing:0.06em;",
...
server <- function(input, output, session) {
  ...
  wvs_y_label <- reactive({
    switch(input$y_var,
           ...
           resource_rents     = "Resource Dependency (% of GDP)",
           input$y_var
    )
  })
  ...
  output$wvs_scatter <- renderPlot({
    ...
    overview_pal_base <- c(
      "#a8d8b9", "#2ecc71", "#1a7a4a", "#6b3a8c", "#9b59b6",
    ...
    if (isTRUE(input$color_country)) {
      ...
      p <- p +
        geom_line(aes(group = country), color = "#a8d8b9", alpha = .3, linewidth = .7) +
        geom_point(aes(size  = ifelse(country == "Canada", 5.5, 4),
                       shape = ifelse(country == "Canada", 18L, 16L)),
                   color = "#a8d8b9", alpha = .88) +
        scale_size_identity() +
        scale_shape_identity()
    }
    ...
    # Y-axis formatting
    if (input$y_var == "resource_rents") {
      p <- p + scale_y_continuous(
        labels = scales::number_format(suffix = "%", accuracy = 0.1)
      )
    ...
    p +
      scale_x_continuous(
        ...
        labels = as.character(sort(unique(d$year)))
      ) +
  ...
  #  Copied from Multiple_Regression_Final.Rmd
  #  scale(v2x_polyarchy) ~ scale(polarization) + scale(resource_filled) +
  #    scale(logged_wealth) + scale(gini_disp) + scale(digital_proxy) +
  #    scale(party_strength) + scale(authoritarian_values_index)
  #  Unit of analysis: country × WVS wave
  # ══════════════════════════════════════════════════════════════════

  # ── Build final_regression_df (mirrors Rmd "Triple Merge Script") ──────────
  # All source objects (vdem_indicators, wb_data_clean, swiid_clean, wvs_indexed)
  # must exist in the global environment (loaded from their respective files).
  # If any are missing the tab shows a clear error message rather than crashing.
  ...
  final_regression_df <- tryCatch({
    ...
    # Expects a data frame wb_data_clean with cols iso3c, year, resource_rents, gni_pc
    ...
    # --- 4. WVS authoritarian values index ---
    library(countrycode)
    ...
    # Return NULL so downstream reactives can show an informative message
    NULL
  })

  # ── Fitted model (exact formula from Rmd) ───────────────────────────────────
  ...
  reg_term_label_global <- function(term) {
    lookup <- c(
      "(Intercept)"                          = "Intercept",
      "scale(polarization)"                  = "Social Polarization",
      "scale(resource_filled)"               = "Resource Dependency",
      "scale(logged_wealth)"                 = "Wealth (ln GNI p.c.)",
      "scale(gini_disp)"                     = "Inequality (Gini)",
      "scale(digital_proxy)"                 = "Digital Freedom",
      "scale(party_strength)"                = "Party Strength",
      "scale(authoritarian_values_index)"    = "Public Auth. Values"
    )
  ...
  output$reg_formula_display <- renderUI({
    div(class = "reg-formula-box",
        div(class = "eq-main",
            tags$span("scale(Polyarchy)"), tags$sub("i"),
            tags$span(" = β₀"),
            tags$span(class = "eq-active", " + β₁·Polarization"),
            tags$span(class = "eq-active", " + β₂·ResourceDep"),
            tags$span(class = "eq-active", " + β₃·ln(Wealth)"),
            tags$span(class = "eq-active", " + β₄·Gini"),
            tags$span(class = "eq-active", " + β₅·DigFreedom"),
            tags$span(class = "eq-active", " + β₆·PartyStrength"),
            tags$span(class = "eq-active", " + β₇·AuthValues"),
            tags$span(" + ε"), tags$sub("i")
        ),
        tags$br(),
        tags$span(style = "font-size:0.62rem; color:#5a5470;",
                  "Global cross-national model. i = country × WVS wave. ",
                  "All predictors standardized (scaled). Sources: V-Dem · WB · SWIID · WVS.")
    )
  })
  ...
  output$reg_coef_table <- renderTable({
    if (is.null(reg_model_global)) {
      return(data.frame(
        Note = "Model could not be fitted. Ensure vdem, wb_data_clean, swiid_clean, and wvs_indexed are loaded."
      ))
    }
    broom::tidy(reg_model_global, conf.int = TRUE) %>%
      mutate(
        Term        = reg_term_label_global(term),
  ...
  output$reg_coef_plot <- renderPlot({
      ...
      return(
        ggplot() +
          annotate("text", x = 0.5, y = 0.5,
                   label = "Model data not available.\nCheck that all source datasets are loaded.",
    ...
    broom::tidy(reg_model_global, conf.int = TRUE) %>%
      ...
      mutate(
        label = reg_term_label_global(term),
        col   = ifelse(estimate > 0, "#a8d8b9", "#e06c75"),
        sig   = p.value < 0.05
      ) %>%
      ...
      coord_flip() +
      labs(x = NULL, y = "Standardized Coefficient (β)",
           subtitle = "Larger point = p < 0.05  ·  green = positive association  ·  red = negative  ·  all vars scaled") +
  ...
  output$reg_resid_plot <- renderPlot({
    if (is.null(reg_model_global) || is.null(final_regression_df)) {
      return(
        ggplot() +
          annotate("text", x = 0.5, y = 0.5,
                   label = "Model data not available.",
    ...
    data.frame(
      fitted   = fitted(reg_model_global),
      residual = residuals(reg_model_global),
      country  = final_regression_df$country_text_id
    ) %>%
      ggplot(aes(x = fitted, y = residual, label = country)) +
      geom_hline(yintercept = 0, colour = "#2a2840", linewidth = 0.8) +
      geom_point(colour = "#a8d8b9", size = 2.2, alpha = 0.65) +
      ggrepel::geom_text_repel(colour = "#a09ab0", size = 2.4, family = "mono",
                               box.padding = 0.3, max.overlaps = 12) +
      labs(x = "Fitted values  (model predicted)",
           y = "Residual  (prediction error)",
           subtitle = "Points close to the zero line = good fit  ·  each point is a country × wave") +
      theme_minimal(base_family = "mono") +
      theme(
        plot.background  = element_rect(fill = "#13161f", colour = NA),
        panel.background = element_rect(fill = "#13161f", colour = NA),
